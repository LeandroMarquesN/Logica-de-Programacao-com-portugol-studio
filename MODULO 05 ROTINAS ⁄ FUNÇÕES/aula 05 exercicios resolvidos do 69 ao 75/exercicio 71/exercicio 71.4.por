 ...
 * 
 * por ultimo agora vou chamer um afunção dentro da função menssagem ! esta função se cham linha() onde ela recebera como parametro
 * a o valor da variavel (tam)msg!
 * 
 * ou seja ela vai mostrar a quantidade precisa de traços na tela de acordo com a messagem que o usuario digitar!!
 * 
 */
